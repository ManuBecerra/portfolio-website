...
<title>Manuel Becerra | Product Designer · AI Evaluation · Berlin</title>
...
/* Title */
.ptit{font-size:clamp(16px,1.6vw,20px);font-weight:700;letter-spacing:-.5px;line-height:1.2;margin-bottom:10px;color:var(--ink);min-height:calc(1.2em * 2)}

/* Description */
.pdsc{font-size:13.5px;line-height:1.76;margin-bottom:6px;font-weight:300;color:var(--muted);min-height:calc(1.76em * 3)}
...
.now-desc {
  ...
  font-weight:300; margin:0 0 14px; min-height:calc(1.76em * 3);
}
.now-cta {
...
.now-tag {
  font-size:11px; padding:4px 10px; border:1px solid var(--bdr);
...
<nav id="nav">
  ...
  <div class="nav-r">
    ...
    <ul class="nav-links">
      ...
      <li><a href="https://www.linkedin.com/in/manubecerra" target="_blank" rel="noopener noreferrer" class="nav-cv">LinkedIn</a></li>
    </ul>
...
<div class="page active" id="pg-home">
  ...
  <div class="stats fade">
    ...
    <div class="st"><div class="n">2</div><div class="l">AI products designed end-to-end</div></div>
  ...
  <section class="sec fade" id="about">
    <div class="ag">
      <div class="abt">
        ...
        <p>I'm Manuel. My design background started in advertising and photography, before I ever touched a product.</p>
        <p>At <strong>Lengoo</strong> that became product design combined with ownership, Flow's trust systems, then HALOS Console solo. At <strong>Cognigy</strong> I went further technical, APIs, logs, model behavior.</p>
      ...
      <div class="pillars">
        <div class="pil">
          <h4>Brand instinct.</h4>
          <p>Nine years in advertising and photography before product. That's where I learned what makes someone trust something instantly, or not at all.</p>
        </div>
        <div class="pil">
          <h4>Product ownership.</h4>
          <p>Design combined with real ownership at Lengoo. I designed Flow's trust systems, then took HALOS Console on solo.</p>
        </div>
        <div class="pil">
          <h4>Real technical fluency.</h4>
          <p>Conversational AI at Cognigy. APIs, logs, model behavior. Most designers never touch that layer. I stay close to it on purpose.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="sec fade" id="work">
    ...
    <div class="stitle">Selected work. One pattern:<br>see a broken workflow, build the system that fixes it.</div>
    <div class="pg">
      ...
      <article class="pc pc-card pc-halos" onclick="show('halos')">
        ...
        <div class="pc-body">
          <span class="ptag">Product Design · AI Systems · Lengoo</span>
          <div class="pmet">+15%</div>
          <div class="ptit">HALOS: AI Model<br>Customization</div>
          <p class="pdsc">Designed the interface for training and deploying custom AI models end to end. Result: +15% CSAT and +20% adoption.</p>
          <div class="pc-halos-meta">
            <span class="pc-halos-pill">Discovery</span>
            <span class="pc-halos-pill">UX Strategy</span>
            <span class="pc-halos-pill">System Design</span>
          </div>
      ...
      <article class="pc pc-card pc-signal" onclick="show('signal')">
        ...
        <div class="pc-body">
          <span class="ptag" style="border-color:var(--sbdr);color:var(--sal);background:var(--sdim)">Product Design · AI Initiative · Enterprise SaaS</span>
  ...
  <section class="sec fade" id="currently">
    ...
    <div class="now-grid">
      <div class="now-col">
        ...
        <div class="now-tags">
          <span class="now-tag">5 scenarios</span>
          <span class="now-tag">3 models</span>
          <span class="now-tag">Claude-as-judge scoring</span>
          <span class="now-tag">Live on n8n</span>
        </div>
      </div>
      <div class="now-col">
        ...
        <div class="now-tags">
          <span class="now-tag">Job discovery agent</span>
          <span class="now-tag">Cover letter generator</span>
          <span class="now-tag">Interview drills</span>
          <span class="now-tag">Job-fit scoring</span>
          <span class="now-tag">Claude &amp; OpenAI APIs</span>
        </div>
      </div>
      <div class="now-col">
        ...
        <div class="now-tags">
          <span class="now-tag">4 categories</span>
          <span class="now-tag">3 severities</span>
          <span class="now-tag">Slack &amp; Jira routing</span>
          <span class="now-tag">Confidence scores</span>
        </div>
  ...
  <section class="sec fade" id="testimonials">
    <div class="lbl">What people say</div>
    <div class="stitle">People I've worked with.</div>
    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:24px;margin-top:32px">
      <div class="pil">
        ...
        <div style="margin-top:auto;padding-top:16px">
          <h4 style="font-size:14px">Yousef</h4>
      ...
      <div class="pil">
        ...
        <div style="margin-top:auto;padding-top:16px">
          <h4 style="font-size:14px">Camila</h4>
      ...
      <div class="pil">
        ...
        <div style="margin-top:auto;padding-top:16px">
          <h4 style="font-size:14px">Ian</h4>
      ...
      <div class="pil">
        ...
        <div style="margin-top:auto;padding-top:16px">
          <h4 style="font-size:14px">Nico</h4>
  ...
  <section class="sec fade" id="ways">
    ...
    <div class="ways-grid">
      <div class="way-col">
        ...
        <div class="way-title">Product Designer role</div>
        <p class="way-desc">A permanent design role at a product-led company. AI, B2B SaaS, or technical platforms. Berlin, hybrid, or remote. Own a product area end to end.</p>
      </div>
      <div class="way-col">
  ...
  <section class="sec fade" id="contact">
    <div class="cog">
      <div class="col">
        ...
        <p>Permanent Product Designer roles, project work, or a 15-minute intro to see if there is a fit. <strong>B2B SaaS, AI, technical platforms.</strong> Berlin, hybrid, or remote. I reply the same day.</p>
        ...
        <div class="socs">
          ...
          <a href="https://www.linkedin.com/in/manubecerra" class="soc" target="_blank" rel="noopener noreferrer" onclick="if(typeof gtag==='function')gtag('event','cv_download',{location:'contact'});">View LinkedIn</a>
        </div>
      </div>
...
<script>
(function(){
  var target = document.getElementById('heroTypeTarget');
  if (!target) return;
  var text = 'Product Designer \u00B7 AI Evaluation \u00B7 Berlin';
