...
#pg-aneekaa{--ca:var(--na);--cal:var(--nal);--cadim:var(--ndim);--cabdr:var(--nbdr);--caglow:rgba(245,200,0,.22)}
...
.h1-line-inner {
  ...
  opacity: 0;
  animation: lineReveal .8s cubic-bezier(.22,1,.36,1) forwards;
}
...
/* ── 7. MAGNETIC BTN ── */
.btn-p {
  transition: opacity .2s, box-shadow .2s, transform .25s cubic-bezier(.22,1,.36,1) !important;
...
.pc-card {
  ...
  will-change: transform;
  transition: transform .55s cubic-bezier(.22,1,.36,1), border-color .3s;
}
...
body.cursor-hover #cur   { width:12px; height:12px; }
body.cursor-hover #cur-r { width:48px; height:48px; border-color:var(--al); opacity:.6; }
body.cursor-mag   #cur-r { width:56px; height:56px; border-color:var(--al); opacity:.8; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  *::after {
  ...
  .mbar.fade-group > .mi,
  .art > *,
  .cs-pillars.fade-group > .cspil,
  .pm-decisions.fade-group > .pm-dec,
  .sig-glance.fade-group > .sig-mini,
  .res-bar.fade-group > *,
  .brand-section,
  .how-grid.fade-group > .how-col,
  .pillars.fade-group > .pil {
...
.ph-body .back {
  ...
  animation:heroIn .5s cubic-bezier(.22,1,.36,1) .05s forwards;
}
.ph-body .ph-tags {
  opacity:0; transform:translateY(14px);
  animation:heroIn .6s cubic-bezier(.22,1,.36,1) .12s forwards;
}
.ph-body .ph-ttl {
  opacity:0;
  animation:heroIn .7s cubic-bezier(.22,1,.36,1) .20s forwards;
}
.ph-body .ph-sub {
  opacity:0; transform:translateY(14px);
  animation:heroIn .6s cubic-bezier(.22,1,.36,1) .30s forwards;
}
...
.mbar.fade-group.in > .mi:nth-child(1){opacity:1;transform:none;transition-delay:.00s}
.mbar.fade-group.in > .mi:nth-child(2){opacity:1;transform:none;transition-delay:.08s}
.mbar.fade-group.in > .mi:nth-child(3){opacity:1;transform:none;transition-delay:.16s}
.mbar.fade-group.in > .mi:nth-child(4){opacity:1;transform:none;transition-delay:.24s}

/* Art body — each block fades as it scrolls in */
.art > * {
  opacity:0; transform:translateY(18px);
  transition:opacity .55s ease, transform .55s cubic-bezier(.22,1,.36,1);
}
.art > *.art-in { opacity:1; transform:none; }
...
.cs-pillars.fade-group.in > .cspil:nth-child(1){opacity:1;transform:none;transition-delay:.00s}
.cs-pillars.fade-group.in > .cspil:nth-child(2){opacity:1;transform:none;transition-delay:.09s}
.cs-pillars.fade-group.in > .cspil:nth-child(3){opacity:1;transform:none;transition-delay:.18s}
...
.pm-decisions.fade-group.in > .pm-dec:nth-child(1){opacity:1;transform:none;transition-delay:.00s}
.pm-decisions.fade-group.in > .pm-dec:nth-child(2){opacity:1;transform:none;transition-delay:.10s}
.pm-decisions.fade-group.in > .pm-dec:nth-child(3){opacity:1;transform:none;transition-delay:.20s}
...
.sig-glance.fade-group.in > .sig-mini:nth-child(1){opacity:1;transform:none;transition-delay:.00s}
.sig-glance.fade-group.in > .sig-mini:nth-child(2){opacity:1;transform:none;transition-delay:.07s}
.sig-glance.fade-group.in > .sig-mini:nth-child(3){opacity:1;transform:none;transition-delay:.14s}
.sig-glance.fade-group.in > .sig-mini:nth-child(4){opacity:1;transform:none;transition-delay:.21s}
.sig-glance.fade-group.in > .sig-mini:nth-child(5){opacity:1;transform:none;transition-delay:.28s}
...
.res-bar.fade-group.in > *:nth-child(1){opacity:1;transform:none;transition-delay:.00s}
.res-bar.fade-group.in > *:nth-child(2){opacity:1;transform:none;transition-delay:.08s}
.res-bar.fade-group.in > *:nth-child(3){opacity:1;transform:none;transition-delay:.16s}
.res-bar.fade-group.in > *:nth-child(4){opacity:1;transform:none;transition-delay:.24s}
...
.brand-section.art-in { opacity:1; transform:none; }
...
.how-grid.fade-group.in > .how-col:nth-child(1){opacity:1;transform:none;transition-delay:.00s}
.how-grid.fade-group.in > .how-col:nth-child(2){opacity:1;transform:none;transition-delay:.08s}
.how-grid.fade-group.in > .how-col:nth-child(3){opacity:1;transform:none;transition-delay:.16s}
.how-grid.fade-group.in > .how-col:nth-child(4){opacity:1;transform:none;transition-delay:.24s}
...
.pillars.fade-group.in > .pil:nth-child(1){opacity:1;transform:none;transition-delay:.00s}
.pillars.fade-group.in > .pil:nth-child(2){opacity:1;transform:none;transition-delay:.09s}
.pillars.fade-group.in > .pil:nth-child(3){opacity:1;transform:none;transition-delay:.18s}
.pillars.fade-group.in > .pil:nth-child(4){opacity:1;transform:none;transition-delay:.27s}
...
<div class="page active" id="pg-home">
  ...
  <section class="hero">
    ...
    <div class="hero-left">
      ...
      <div class="h1">
        <span class="h1-line"><span class="h1-line-inner"><span>Making </span><span class="g">complex AI</span></span></span>
        <span class="h1-line"><span class="h1-line-inner"><span class="ghost">feel</span></span></span>
        <span class="h1-line"><span class="h1-line-inner"><span>simple to use</span></span></span>
      </div>
      <p class="hero-sub">
  ...
  <section class="sec fade" id="about">
    <div class="ag">
      <div class="abt">
        <div class="lbl"><span class="lbl-inner">About</span></div>
        <div class="stitle"><span class="stitle-inner">Berlin-based PM.<br>UX background.</span></div>
  ...
  <section class="sec fade fade-group" id="work">
    <div class="lbl"><span class="lbl-inner">Selected Work</span></div>
    <div class="stitle"><span class="stitle-inner">Case studies.</span></div>
    <div class="pg fade-group">
...
<div class="page" id="pg-halos">
  <div class="ph">
    ...
    <div class="mbar fade fade-group">
  ...
  <div class="art">
    ...
    <div class="cs-pillars fade-group">
      <div class="cspil">
...
<div class="page" id="pg-aneekaa" style="background:#fff;color:#111">
...
#pg-aneekaa .an-logo {
  ...
  letter-spacing:-.5px;color:#111;display:flex;align-items:center;gap:10px;
}
...
#pg-aneekaa .an-back:hover { color:#111; }
...
#pg-aneekaa .an-stat-n {
  ...
  color:#111;line-height:1;margin-bottom:8px;
}
...
#pg-aneekaa .an-intro-body p strong { color:#111;font-weight:700; }
...
#pg-aneekaa .an-intro-body blockquote p {
  font-size:20px;font-style:italic;color:#111;
}
...
#pg-aneekaa .an-section-title {
  font-size:clamp(32px,4vw,56px);font-weight:800;letter-spacing:-2px;color:#111;
}
...
#pg-aneekaa .an-service:hover { background:#fffbe6; }
...
#pg-aneekaa .an-project-name {
  ...
  color:#111;margin-bottom:12px;line-height:1.05;
}
...
#pg-aneekaa .an-project-desc strong { color:#111;font-weight:600; }
#pg-aneekaa .an-project-link {
  display:inline-flex;align-items:center;gap:8px;margin-top:28px;
  font-size:12px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;
  color:#111;border-bottom:2px solid #f5c800;padding-bottom:2px;
...
#pg-aneekaa .an-client:hover { color:#111; }
...
#pg-aneekaa .an-footer-next:hover { background:#fffbe6; }
#pg-aneekaa .an-footer-next-label {
  font-size:9px;font-weight:700;letter-spacing:.16em;text-transform:uppercase;
  color:#bbb;margin-bottom:12px;
}
#pg-aneekaa .an-footer-next-title {
  font-size:clamp(22px,3vw,38px);font-weight:800;letter-spacing:-1.5px;color:#111;
...
#pg-aneekaa .an-footer-back a:hover { border-color:#111;color:#111; }
#pg-aneekaa .an-foot {
...
#pg-aneekaa .an-foot a:hover { color:#111; }
...
@media(max-width:860px){
  ...
  <div class="an-nav">
    <div class="an-logo">
      <img src="https://aneekaa.com/wp-content/uploads/cropped-logoweb@100x.png" alt="Aneekaa">
      aneekaa <span style="font-weight:300;color:#999">| studio</span>
    </div>
    <span class="an-back" onclick="show('home')">← Back to portfolio</span>
  </div>
  ...
  <div class="an-project">
    ...
    <div class="an-img-full an-fade-img" onclick="lbOpen(this)">
      <img src="https://aneekaa.com/wp-content/uploads/Blinkist-logo-1.jpg" alt="Blinkist" data-caption="Blinkist · Corporate video production">
    </div>
  </div>
...
<div class="page" id="pg-signal">
  ...
  <div class="art">
    ...
    <h2>At a glance</h2>
    <div class="sig-glance fade-group">
      <div class="sig-mini">
...
(function loop(){rx+=(mx-rx)*.10;ry+=(my-ry)*.10;cr.style.left=rx+'px';cr.style.top=ry+'px';requestAnimationFrame(loop)})();
...
/* magnetic CTA button */
const magBtns=document.querySelectorAll('.btn-p');
magBtns.forEach(btn=>{
  btn.addEventListener('mousemove',e=>{
    ...
    document.body.classList.add('cursor-mag');
  });
  btn.addEventListener('mouseleave',()=>{
    btn.style.transform='';
    document.body.classList.remove('cursor-mag');
  });
});
...
function show(name,options={}){
  ...
  const doSwap=()=>{
    ...
    if(options.track!==false) trackVirtualPage(name);
...
if(caseStudyPages.has(initialCase)){
  show(initialCase,{replaceUrl:true,track:false,instant:true});
